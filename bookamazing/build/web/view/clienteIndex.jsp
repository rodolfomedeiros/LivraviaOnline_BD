<div class="container-fluid">
    ...
    <div class="panel-group col-lg-2 col-xs-12">
        <ul class="nav nav-list">
            ...
            <li><a href="clienteIndex?tipo=literatura">Literatura</a></li>
            <li><a href="clienteIndex?tipo=didatico">Didático</a></li>
            <li class="nav-divider"></li>
            <li class="nav-tabs">Área de Conhecimento:</li>
            <li><a href="clienteIndex?tipo=didatico&area=informatica">Informática</a></li>
            <li><a href="clienteIndex?tipo=didatico&area=ciencia">Ciência</a></li>
            <li><a href="clienteIndex?tipo=literatura&area=romance">Romance</a></li>
            <li><a href="clienteIndex?tipo=literatura&area=suspense">Suspense</a></li>
            <li><a href="clienteIndex?tipo=literatura&area=ficcao">Ficção</a></li>
        </ul>
    </div>
    <%-- Livros --%>
        ...
        <c:forEach var="livro" items="${sessionScope.livraria.getLivros()}">
            <div class="panel col-lg-3 col-xs-10 col-xs-offset-1 text-center">
                ...
                <div class="row">
                    ...
                    <a href="${url}" class="btn btn-yellow"><span class="glyphicon glyphicon-shopping-cart"></span> Comprar</a>
                </div>
            </div>
        </c:forEach>
    </div>
    ...
    <div id="modalDescribeLivro" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content col-lg-12 col-xs-12">
                ...
                <div class="modal-footer col-lg-12 col-xs-12">
                    <div class="col-lg-4 col-lg-offset-8 col-xs-4 col-xs-offset-8">
                        <a id="modalLivroAdicionar" class="btn btn-yellow"><span class="glyphicon glyphicon-shopping-cart"></span> Adicionar</a>
                    </div>
                </div>
            </div><%-- /.modal-content --%>
        </div><%-- /.modal-dialog --%>
