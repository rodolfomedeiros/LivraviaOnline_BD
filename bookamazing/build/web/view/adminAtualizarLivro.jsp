...
<div class="container-fluid">
    ...
    <div class="panel-group col-lg-6 col-xs-12">
        <form method="post" enctype="multipart/form-data">
            ...
            <%-- panel 02 --%>
            <div class="panel panel-default col-lg-12 col-xs-12">
                <div class="panel-heading text-center col-lg-12 col-xs-12"><h6>INFORME OS NOVOS ATRIBUTOS!</h6></div>
                <div class="panel-body col-lg-12 col-xs-12">
                ...
                <div class="panel-footer col-lg-12 col-xs-12">
                    ...
                    <div class="col-lg-3 col-xs-6">
                        <button type="submit" class="btn btn-primary" formaction="adminAtualizarLivro">Atualizar</button>
                    </div>
                </div>
            </div>
        </form>
